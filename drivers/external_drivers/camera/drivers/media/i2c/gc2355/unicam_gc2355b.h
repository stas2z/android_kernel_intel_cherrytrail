...
S_UNI_REG  gc2355b_global_setting[] = {
...
S_UNI_REG  gc2355b_group_hold_start[] = {
	{UNICAM_8BIT, 0xfe, 0x00},
	{UNICAM_TOK_TERM, 0, 0}
};
S_UNI_REG  gc2355b_group_hold_end[] = {
	{UNICAM_8BIT, 0xfe, 0x00},
	{UNICAM_TOK_TERM, 0, 0}
};

static  int gc2355b_adgain_p[] = {
	0,
};
...
S_UNI_REG gc2355b_still_1600x1200_30fps[] = {
	{UNICAM_8BIT, 0xfe, 0x00},
...
#define GC2355B_ANALOG_GAIN_1                   64  // 1.00x
#define GC2355B_ANALOG_GAIN_2                   88  // 1.375x
#define GC2355B_ANALOG_GAIN_3                   122  // 1.90x
#define GC2355B_ANALOG_GAIN_4                   168  // 2.625x
#define GC2355B_ANALOG_GAIN_5                   239  // 3.738x
#define GC2355B_ANALOG_GAIN_6                   330  // 5.163x
#define GC2355B_ANALOG_GAIN_7                   470  // 7.350x


static S_UNI_RESOLUTION gc2355b_res_preview[] = {
	/*{
		.desc = "gc2355b_720p",
		...
		.bin_mode = 0,
		.skip_frames = 5,
		.regs = gc2355b_720p_30fps,
		.regs_n= (ARRAY_SIZE(gc2355b_720p_30fps)),
	...
	},*/
	{
		...
		.bin_mode = 0,
		.skip_frames = 5,
		.regs = gc2355b_still_1600x1200_30fps,
		.regs_n= (ARRAY_SIZE(gc2355b_still_1600x1200_30fps)),
...
static S_UNI_DEVICE gc2355b_unidev={
	...
	.exposeadgain_param=gc2355b_adgain_p,
	.exposeadgain_n=(ARRAY_SIZE(gc2355b_adgain_p)),
	.exposeadgain_min=0,
	...
	.global_setting=gc2355b_global_setting,
	.global_setting_n=(ARRAY_SIZE(gc2355b_global_setting)),
	.stream_off=gc2355b_stream_off,
	.stream_off_n=(ARRAY_SIZE(gc2355b_stream_off)),
	.stream_on=gc2355b_stream_on,
	.stream_on_n=(ARRAY_SIZE(gc2355b_stream_on)),
	.group_hold_start=gc2355b_group_hold_start,
	.group_hold_start_n=(ARRAY_SIZE(gc2355b_group_hold_start)),
	.group_hold_end=gc2355b_group_hold_end,
	.group_hold_end_n=(ARRAY_SIZE(gc2355b_group_hold_end)),

	.ress=gc2355b_res_preview,
	.ress_n=(ARRAY_SIZE(gc2355b_res_preview)),
	...
	.hw_port=1, //ATOMISP_CAMERA_PORT_SECONDARY,
	.hw_lane=1, //
