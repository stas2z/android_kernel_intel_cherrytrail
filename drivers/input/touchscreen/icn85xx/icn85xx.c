...
#include "icn85xx_fw_hi8.h"
//#define SUPPORT_SENSOR_ID	1
#define ICN85XX_IRQ		137
#define ICN85XX_SCREEN_MAX_X	1200
#define ICN85XX_SCREEN_MAX_Y	1920
#elif defined(CONFIG_CHUWI_HI10PRO)
#include "icn85xx_fw200.h"
#define ICN85XX_IRQ		0xB9
#define ICN85XX_SCREEN_MAX_X	1200
#define ICN85XX_SCREEN_MAX_Y	1920
#elif defined(CONFIG_CHUWI_VI10PLUS)
#include "icn85xx_fw200.h"
#define ICN85XX_IRQ		0x64
#define ICN85XX_SCREEN_MAX_X	1200
#define ICN85XX_SCREEN_MAX_Y	1920
#else
...
static struct sensor_id sensor_id_table[] = {
                   { 0x22, "/system/etc/firmware/icn85xx_fw_22.BIN",icn85xx_fw_22,sizeof(icn85xx_fw_22)},//default bin or fw
                   { 0x11, "/system/etc/firmware/icn85xx_fw_11.BIN",icn85xx_fw_11,sizeof(icn85xx_fw_11)},
...
static ssize_t icn85xx_store_update(struct device_driver *drv,const char *buf, size_t len)
{
	...
	case 'D':   
		     ...
		     break;
	default:
		printk("this command is unknown!!\n");
	break;		
	}
	#if 0
